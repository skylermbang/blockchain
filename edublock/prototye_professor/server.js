...
app.post('/cert', async(req, res)=>{
    ...
    console.log("add cert: " + req.body.id + "," + req.body.owner + "," + req.body.certname + "," + req.body.date + "," + req.body.school);
    ...
    const network = await gateway.getNetwork('mychannel');
    const contract = network.getContract('edublock');
    const result = await contract.submitTransaction('addCerti', id, owner, certname, date, school);
